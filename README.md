# Repositorio de Proyectos - Tópicos de Inteligencia Artificial

Este repositorio contiene los proyectos y trabajos de investigación desarrollados para la materia de **Tópicos de Inteligencia Artificial**.
...
- ### 📁 [Unidad 4](./Unidad4/)
  - ### Sistema de detección de placas vehiculares
    - **Descripción:** Desarrollo de un sistema integral de reconocimiento automático de matrículas (ALPR) y gestión de incidencias vehiculares. La solución integra una aplicación móvil desarrollada en React Native con un pipeline de visión artificial basado en Deep Learning (YOLOv8). Se utiliza un enfoque de dos etapas (detección de placa y segmentación de caracteres) junto con OCR para extraer la información, permitiendo consultar en tiempo real el estatus del propietario y automatizar el control de acceso mediante reglas de negocio para vehículos infractores.
